...
3. **Development/debugging**: Use `vecshift_integrated()` with verbose output
4. **Raw processing**: Use `vecshift(classify_status = FALSE)` for maximum speed

...
test_that("vecshift handles multiple part-time overlapping jobs", {
  ...
  # Should have over_pt status (same-type overlap uses single label)
  expect_true("over_pt" %in% overlap_segments$stato)
})
...
test_that("vecshift handles multiple full-time overlapping jobs", {
  ...
  # Should have over_ft status (same-type overlap uses single label)
  expect_true("over_ft" %in% overlap_segments$stato)
})

...
generate_test_data_with_issues <- function(
  issue_type,
  n_records = 10,
  n_persons = 3
) {
  ...
  switch(
    ...
    "clean_data" = {
      inizio_vals <- as.Date("2023-01-01") + sample(0:365, n_records)
      data.table(
        id = 1:n_records,
        cf = rep(
          paste0("PERSON", sprintf("%03d", 1:n_persons)),
          length.out = n_records
        ),
        inizio = inizio_vals,
        fine = inizio_vals + sample(30:365, n_records, replace = TRUE),
    ...
    "missing_values" = {
      dt <- data.table(
        ...
        inizio = c(
          as.Date(c("2023-01-01", "2023-03-01", "2023-06-01")),
          as.Date(c("2023-02-01", "2023-05-01", "2023-08-01")),
          as.Date(c("2023-01-15", "2023-07-01")),
          NA,
          as.Date("2023-12-01")
        ),
        fine = c(
          as.Date(c("2023-02-28", "2023-05-31", "2023-09-30")),
          as.Date(c("2023-04-30", "2023-07-31", "2023-11-30")),
          as.Date(c("2023-03-15", "2023-10-31")),
          as.Date("2023-06-15"),
          NA
        ),
    ...
    "zero_duration" = {
      data.table(
        ...
        fine = as.Date(c(
          "2023-01-31",
          "2023-01-15",
          "2023-02-01", # 2nd and 3rd are zero duration
          "2023-03-31",
          "2023-03-15",
          "2023-04-01"
        )), # 2nd and 3rd are zero duration
        prior = c(1, 0, 1, 0, 1, 0)
      )
    },
    ...
    "batch_processing_pattern" = {
      ...
      data.table(
        ...
        cf = rep(
          paste0("PERSON", sprintf("%03d", 1:10)),
    ...
    "weekend_starts" = {
      ...
      weekend_dates <- saturday_start +
        c(0, 1, 7, 8, 14, 15, 21, 22, 28, 29, 35, 36) # Mix of Saturdays and Sundays
      ...
      data.table(
        ...
        prior = sample(
          c(0, 1),
          length(weekend_dates) + length(regular_dates),
          replace = TRUE
        )
      )
    },
    ...
    "very_short_contracts" = {
      data.table(
        ...
        fine = as.Date("2023-01-01") +
          0:9 * 10 +
          c(0, 0, 1, 1, 2, 0, 1, 0, 2, 1), # Many 1-day contracts
  ...
  switch(
    ...
    "database_style" = {
      dt <- data.table(
        ...
        CONTRACT_START_DATE = as.Date(c(
          "2023-01-01",
          "2023-06-01",
          "2023-02-01",
          "2023-07-01"
        )),
        CONTRACT_END_DATE = as.Date(c(
          "2023-05-31",
          "2023-12-31",
          "2023-06-30",
          "2023-11-30"
    ...
    "extra_columns" = {
      dt <- data.table(
        ...
        contract_start = as.Date(c(
          "2023-01-01",
          "2023-04-01",
          "2023-02-01",
          "2023-06-01"
        )),
        contract_end = as.Date(c(
          "2023-03-31",
          "2023-08-31",
          "2023-05-31",
          "2023-10-31"
  ...
  switch(
    ...
    "event_generation" = {
      list(
        ...
        expected_start_dates = as.Date(c(
          "2023-01-01",
          "2023-03-01",
          "2023-06-01"
        )),
        expected_end_dates = as.Date(c(
          "2023-03-01",
          "2023-06-01",
          "2023-09-01"
        )), # FINE + 1

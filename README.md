...
Montaletti, G. (2026). *vecshift: Temporal Analysis of Employment Data with Event-Based Processing* (Version 1.2.0) [Computer software]. https://github.com/gmontaletti/vecshift
